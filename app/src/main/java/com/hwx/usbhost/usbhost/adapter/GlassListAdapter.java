...
public class GlassListAdapter extends BaseQuickAdapter<Glass,BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder baseViewHolder, Glass glass) {
        ...
        DrawableUtil.displayImage(baseViewHolder.convertView.getContext(), (ImageView) baseViewHolder.getView(R.id.image),getTypeUrl(glass.getType()));
    }
