...
public class FilePickerActivity extends AppCompatActivity implements DirectoryFragment.FileClickListener {
    ...
    public static final String ARG_returnArgs = "arg_returnArgs";
    ...
    private void initArguments() {
        ...
        if (getIntent().hasExtra(ARG_returnArgs)) {
            returnArgs = getIntent().getStringExtra(ARG_returnArgs);
        }
    ...
    private void initToolbar() {
        ...
        mToolbar.setBackgroundColor(getResources().getColor(R.color.item_file_title_color));
    ...
    private void handleFileClicked(final File clickedFile) {
        if (clickedFile.isDirectory()) {
            ...
            if (clickedFile==null)
                finish();
            FileTypeUtils.FileType fileType = FileTypeUtils.getFileType(clickedFile);
            if (fileType.getDescription()!=R.string.type_photo)
                Snackbar.make(mToolbar, R.string.vfaddsfware,Snackbar.LENGTH_SHORT).setAction(R.string.vdaffssdew, new View.OnClickListener() {
                    @Override
